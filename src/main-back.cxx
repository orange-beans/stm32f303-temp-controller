...
// AnalogIn tempReadB(PA_1);

//PWM pins
// PwmOut heaterA(PA_11);
// PwmOut heaterB(PA_8);
...
//   pc.printf("setPoints: %3.1f'C %f3.1'C\n", setPointA, setPointB);
//   pc.printf("%s\n", holder.c_str());
// }
//
...
//     // heaterB.write(outB);
//
//     pc.printf("HeaterA: Temp: %3.1f 'C, PWM: %3.3f %%; HeaterB: Temp: %3.1f 'C, PWM: %3.3f %%;\n", tempA, outA*100, tempB, outB*100);
//     wait(RATE);
//
//     // Test WS2812
